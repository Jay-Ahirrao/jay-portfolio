            ...
            >
              ...
              <div className="space-y-6 text-lg text-neutral-400 leading-relaxed">
                ...
                <div className="flex items-center gap-6 pt-8">
                  <MagneticButton>
                    <a href="https://github.com/Jay-Ahirrao" target="_blank" rel="noopener noreferrer" className="text-neutral-500 hover:text-white transition-colors">
                      <Github size={20} />
                    </a>
                  </MagneticButton>
                  <MagneticButton>
                    <a href="https://linkedin.com/in/jay-ahirrao" target="_blank" rel="noopener noreferrer" className="text-neutral-500 hover:text-white transition-colors">
                      <Linkedin size={20} />
                    </a>
                  </MagneticButton>
                  <MagneticButton>
                    <a href="https://leetcode.com/u/jay-ahirrao" target="_blank" rel="noopener noreferrer" className="text-neutral-500 hover:text-white transition-colors">
                  ...
                  <MagneticButton>
                    <a href="https://codechef.com/users/jay_ahirrao" target="_blank" rel="noopener noreferrer" className="text-neutral-500 hover:text-white transition-colors">
                      <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
                  ...
                  <MagneticButton>
                    <a href="mailto:jayahirrao11@gmail.com" className="text-neutral-500 hover:text-white transition-colors">
                      <Mail size={20} />
                    </a>
                  </MagneticButton>
                </div>
