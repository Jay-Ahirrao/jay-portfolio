...
const About = () => {
  ...
  return (
    <section id="about" className="py-24 relative z-10 overflow-hidden">
      <div className="container mx-auto px-6 xl:px-12 max-w-7xl">
        <div className="flex flex-col lg:flex-row items-center justify-between gap-16 lg:gap-40">
          ...
          <div className="w-full lg:w-1/2">
            <motion.div
              ...
              className="max-w-xl"
            >
              <motion.h5 variants={itemVariants} className="font-mono text-xs tracking-[0.2em] text-neutral-400 uppercase mb-4">
                More About Me
              </motion.h5>
              <motion.h2
              ...
              <motion.div variants={itemVariants} className="space-y-6 text-lg text-neutral-400 leading-[1.8]">
                <p>
                  Hey! I'm <span className="text-white font-medium">Jay Ahirrao</span>, a passionate Full Stack Developer currently pursuing my BTech in IT at RSCOE, Pune.
                </p>
                <p>
                  I specialize in building scalable web architectures and robust backend systems. My journey involves working on diverse projects from EveryTube to Airbnb-inspired booking platforms, focusing heavily on robust backend architecture.
                </p>
                <p className="text-base text-neutral-300 font-medium pt-4">
                  I wake up eager to make a difference and truly thrive on the adrenaline of late-night hackathons!
                </p>
              </motion.div>
              ...
              <motion.div variants={itemVariants} className="flex items-center gap-6 pt-8">
                <MagneticButton>
                  <a href="https://github.com/Jay-Ahirrao" target="_blank" rel="noopener noreferrer" className="text-neutral-300 hover:text-white transition-colors">
                    <Github size={20} />
                  </a>
                </MagneticButton>
                <MagneticButton>
                  <a href="https://linkedin.com/in/jay-ahirrao" target="_blank" rel="noopener noreferrer" className="text-neutral-300 hover:text-white transition-colors">
                    <Linkedin size={20} />
                  </a>
                </MagneticButton>
                <MagneticButton>
                  <a href="https://leetcode.com/u/jay-ahirrao" target="_blank" rel="noopener noreferrer" className="text-neutral-300 hover:text-white transition-colors">
                ...
                <MagneticButton>
                  <a href="https://codechef.com/users/jay_ahirrao" target="_blank" rel="noopener noreferrer" className="text-neutral-300 hover:text-white transition-colors">
                    <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
                ...
                <MagneticButton>
                  <a href="mailto:jayahirrao11@gmail.com" className="text-neutral-300 hover:text-white transition-colors">
                    <Mail size={20} />
                  </a>
                </MagneticButton>
              </motion.div>
